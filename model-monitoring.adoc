...
You should see the "XRay Lab" dashboard we just created under "Recently viewed dashboards" on the front page:

image::grafana-recent-dashboards.png[grafana-recent-dashboards, 700]
