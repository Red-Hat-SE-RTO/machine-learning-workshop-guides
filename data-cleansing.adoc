...
On the *Spawner Options* page select the *s2i-tensorflow-notebook:v0.0.2* image from the first dropdown and click *Start* at the bottom. We'll be using Tensorflow to generate the model in our next step.
